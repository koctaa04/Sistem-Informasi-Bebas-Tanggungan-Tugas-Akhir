        ...
        <table class="user-table">
            ...
            <?php foreach ($dataMahasiswa as $mahasiswa): ?>
                <tr>
                    ...
                    <button class="btn btn-delete" onclick="return confirm('Hapus data ini?') && window.location.href='?action=deleteMahasiswa&nim=<?= $mahasiswa['nim'] ?>'">Hapus</button>
...
<div class="modal fade modal-tambah" id="modalTambah" tabindex="-1" aria-labelledby="modalTambahLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="?action=addMahasiswa" method="POST">
